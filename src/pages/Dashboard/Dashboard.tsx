const Dashboard = () => {
  return (
    <div className="w-full flex justify-center items-center p-4">
      <div className="w-full grid md:grid-cols-2 text-lg grid-cols-1 items-center gap-4">
        ...
        <div className="w-full flex flex-col gap-2 items-center justify-center border border-slate-300 shadow-md py-6 px-2 rounded">
          ...
          <span className=" text-4xl font-bold text-blue-500">1200</span>
        </div>
        <div className="w-full flex flex-col gap-2 items-center justify-center border border-slate-300 shadow-md py-6 px-2 rounded">
          <div className=" flex items-center gap-2">
            <svg
        ...
        <div className="w-full flex flex-col gap-2 items-center justify-center border border-slate-300 shadow-md py-6 px-2 rounded">
          ...
          <span className=" text-4xl font-bold text-blue-500">1812</span>
        </div>
      </div>
    </div>
  );
